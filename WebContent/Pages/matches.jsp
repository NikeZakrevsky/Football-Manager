    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">Команда 1 - Команда 2</h2>
                    <hr>
                    <hr class="visible-xs">
                    <p><strong>Название:</strong> Команда 1 - Команда 2</p>
					<p><strong>Счет:</strong> Голы 1 - Голы 2</p>
					<p><strong>Стадион:</strong> Стадион 1</p>
					<p><strong>Турнир:</strong>Турнир 1</p>
				</div>
            </div>
        </div>
